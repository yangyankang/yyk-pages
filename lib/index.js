...
const page = () => {
  return src('src/*.html', { base: config.build.src })
...
const image = () => {
  return src('src/assets/images/**', { base: config.build.src })
...
const font = () => {
  return src('src/assets/fonts/**', { base: config.build.src })
    .pipe(plugins.imagemin())
    .pipe(dest(config.build.dist))
}
...
const useref = ()=> {
  return src('temp/**', { base: config.build.temp})
  .pipe(plugins.useref({
